...
class VisualDataLoader:
    ...
    def _load_samples(self) -> List[Dict]:
        ...
        for label_file in self.labels_dir.glob("daily_sample_*.json"):
            ...
            image_file = self.images_dir / f"daily_chart_{data['date'].replace('-', '')}.png"
    ...
    def _create_dataset_from_samples(self, samples: List[Dict], shuffle: bool = True) -> tf.data.Dataset:
