...
class ViTBaseHybridModel:
    ...
    def create_vit_base_encoder(self) -> keras.Model:
        ...
        representation = layers.GlobalAveragePooling1D(name="vit_base_pool")(patch_embeddings)
        ...
        representation = layers.Dropout(self.model_config['dropout_rate'])(representation)
        ...
        vit_base_encoder = keras.Model(
            ...
            name='vit_base_encoder'
        )
        
        self.logger.info(f"ViT-Base encoder created with {vit_base_encoder.count_params():,} parameters")
    ...
    def add_data_augmentation(self, x):
        ...
        augmentation = keras.Sequential([
            ...
            layers.RandomBrightness(factor=0.03)
    ...
    def add_positional_encoding(self, encoded_patches):
        ...
        num_patches = (self.model_config['image_size'] // self.model_config['patch_size']) ** 2
    ...
    def create_feature_encoder(self) -> keras.Model:
        ...
        normalized_features = layers.BatchNormalization(name='feature_normalization')(feature_input)
        ...
        feature_encoder = keras.Model(
            ...
            outputs=feature_representation,
            name='feature_encoder'
        )
        
        self.logger.info(f"Feature encoder created with {feature_encoder.count_params():,} parameters")
    ...
    def create_hybrid_model(self) -> keras.Model:
        ...
        self.logger.info(f"ViT-Base hybrid model created with {total_params:,} total parameters")
