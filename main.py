...
def main():
    ...
    parser.add_argument('--dataset', type=str, choices=['training', 'validation', 'test'],
                       default='training', help='Type of dataset to generate')
    parser.add_argument('--start-date', type=str, help='Override config start date (YYYY-MM-DD)')
    parser.add_argument('--end-date', type=str, help='Override config end date (YYYY-MM-DD)')
    parser.add_argument('--dry-run', action='store_true', help='Validate configuration without generating data')
