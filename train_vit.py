...
def main():
    ...
    # 25M Parameter ViT Configuration (No Early Stopping)
    config = {
        "batch_size": 8,  # Conservative for 25M model
        "learning_rate": 5e-5,  # Conservative learning rate
        "epochs": 30,  # Full 30 epochs, no early stopping
        "image_size": (224, 224),
        "num_classes": 4,  # 4-class pattern system
    }
    ...
    try:
        ...
        # Initialize trainer
        logger.info("Initializing 25M ViT trainer (no early stopping)...")
