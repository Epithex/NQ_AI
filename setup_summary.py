...
def check_setup_status():
    ...
    if train_manifest.exists() and test_manifest.exists():
        ...
        print(f"   📊 Training: {train_info['total_samples']} samples ({train_info['date_range']['start']} → {train_info['date_range']['end']})")
        print(f"   📊 Testing:  {test_info['total_samples']} samples ({test_info['date_range']['start']} → {test_info['date_range']['end']})")
